...
function Login() {
    ...
    // dispatch hook ka use hum kisi bhi action ko perform krne ke liye karet hai
    const dispatch = useDispatch();

    const register = (e)=>{
        // ye e.preventDefault isliye likha hai taki page Refresh na ho
        e.preventDefault();
        ...
        // ye charo line of code form fill karne ke baad form ko empty bana denge
        setName("");
        setPhotoURL("");
        setEmail("");
        setPassword("");
